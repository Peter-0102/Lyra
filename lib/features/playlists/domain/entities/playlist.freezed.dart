...
abstract class $PlaylistCopyWith<$Res> {
  ...
  $Res call({
    ...
    @_DateTimeConverter() DateTime updatedAt,
  });
}
...
class _$PlaylistImpl extends _Playlist {
  const _$PlaylistImpl({
    ...
    @_DateTimeConverter() required this.updatedAt,
  }) : _songs = songs,
       super._();
  ...
  @override
  String toString() {
    return 'Playlist(id: $id, name: $name, description: $description, songs: $songs, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _Playlist extends Playlist {
  const factory _Playlist({
    ...
    @_DateTimeConverter() required final DateTime updatedAt,
  }) = _$PlaylistImpl;
