...
export function runYtDlp(args: string[], options: YtDlpOptions = {}): Promise<YtDlpResult> {
...
export function buildAudioExtractionArgs(videoId: string, outputTemplate: string): string[] {
  return [
